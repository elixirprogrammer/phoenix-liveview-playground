defmodule LiveviewPlayground.Timeline do
  @moduledoc """
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(LiveviewPlayground.PubSub, "posts")
  end

  defp broadcast({:error, _reason} = error, _event), do: error
  defp broadcast({:ok, post}, event) do
    Phoenix.PubSub.broadcast(LiveviewPlayground.PubSub, "posts", {event, post})
    {:ok, post}
  end
end
